...
class ReleaseNoteConfig(BaseModel):
    ...
    release_output_template: str = Field(
        default=(
        ...
        description="Jinja2 template for GitHub release notes output (master template). "
                    "Available variables: version, title, year, categories, all_notes, render_entry (function). "
                    "This template structures the entire release notes document."
    )
